...
Try {
	...
	[string]$appVendor = 'Carnegie Mellon University'
	[string]$appName = 'Alice'
	[string]$appVersion = '3'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'alice 3' -CheckDiskSpace -PersistPrompt
		...
		Execute-Process -Path "$dirFiles\Alice3_windows-x64_3_5.exe" -Parameters '-q' -WindowStyle 'Hidden'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'alice 3' -CloseAppsCountdown 60
		...
		Execute-Process -Path "$envProgramFiles\Alice 3\uninstall.exe" -Parameters '-q' -WindowStyle 'Hidden'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCmO1JFtsmQ+RQ+
# Gl6GP7S1OxGmDUfLOx0eoPlyis36DaCCFFwwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgmQlr27xW
# DEIzILoNe8Nuvsv1PPS+Xr1k2+e28pQuVogwDQYJKoZIhvcNAQEBBQAEggEAx+Rd
# gZ1Ukib6B64Ki8mKEkJrMScmpHmIw3TgD2xrI9eN3oTtgSKs7V1ZZRkCnSSJWAiY
# 3+Jpf5F1DwgrPt/RZ9wD6hzDa0d+aAaVQSCa+ETn6CstLrbRjyOHsJWjnzIrKtwU
# 4WlZfgf8Sd06NGAXvWUgv30gU3YJceDYY/RWERgzRS1iev/557p2bTuBTyGU30Ay
# eofq79QLFQeSHRodsWFzGYA2Rb9/7ekVZ/dRh7sqVjKPtYUF4jdeb0/oICqzdrvu
# HC2gZCEPprr7tS4B0T+LWP5wZfmOxqBS4eYI6K/ULzf/Zx+/sZFcZB0fpZ5D3L9j
# z5nlhr3c4eeagMsknKGCAqIwggKeBgkqhkiG9w0BCQYxggKPMIICiwIBATBoMFIx
...
# CSqGSIb3DQEJBTEPFw0xOTEwMTAxODUyMjRaMCMGCSqGSIb3DQEJBDEWBBR71c46
# 0sCHtRzsXTdPU99SRn4l/zCBnQYLKoZIhvcNAQkQAgwxgY0wgYowgYcwgYQEFGO4
...
# ggEASdeD1K8y7HquouqS8Sisp/1PKcssfAFRq73DFNTCAFrJLJ8/ggDQ3JiqpQN1
# P9YuK+jnP+jwybNL/GdNINEKoXfJQ8xmFm5mY5c4Yi9jjdwkhapugedktlovRbJm
# CYkyJTTqGt7s/a1f2p5ibhPukXnMuPjorS6Jc3o+3+ymJ1SMOLfFFuIoNgOC6j7r
# /xq0kXRE+2XpYn9uYigpfjuWVxEnXHq/i6TEvmvPP9NSKtzHM3Un8OS6Ut3+c0Aa
# 4AvSir4EBavoBOyzHmIAJQ09runjDTtUh9B4M2a80IfpadXjQleIBo8AerZcfaxH
# EjRoAmC7nGb/mtDfb5FnngMggw==
